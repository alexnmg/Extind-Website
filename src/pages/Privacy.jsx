    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          'Usage measurement, only with your consent. If you accept on the cookie banner, Microsoft Clarity records which pages you open, where you click and how far you scroll and replays it as an anonymous session, and Google Analytics counts visits and tells us which pages are read and where visitors arrive from. Neither is loaded at all unless you accept, and you can withdraw at any time on the Cookie Policy page. Legal basis: your consent (Art. 6(1)(a) GDPR).',
      ...
      },
      {
        ...
        ul: [
          ...
          'Google Ireland Ltd. (Google Analytics) — visit statistics, and only if you accepted them. Google may process this data outside the EU under its standard contractual clauses.',
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          'Măsurarea utilizării, doar cu acordul tău. Dacă accepți în bannerul de cookie-uri, Microsoft Clarity înregistrează ce pagini deschizi, unde dai clic și cât derulezi și reia totul ca sesiune anonimă, iar Google Analytics numără vizitele și ne arată ce pagini sunt citite și de unde vin vizitatorii. Niciunul nu se încarcă dacă nu accepți, iar acordul poate fi retras oricând din pagina Politica de cookie-uri. Temei legal: consimțământul tău (art. 6 alin. (1) lit. a) GDPR).',
      ...
      },
      {
        ...
        ul: [
          ...
          'Google Ireland Ltd. (Google Analytics) — statisticile de vizitare, doar dacă ai acceptat. Google poate prelucra aceste date în afara UE, în baza clauzelor contractuale standard.',
